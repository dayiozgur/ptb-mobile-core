...
final GlobalKey<NavigatorState> rootNavigatorKey =
    GlobalKey<NavigatorState>(debugLabel: 'ppmRootNavigator');

/// PPM router — YALNIZ paylaşılan shell rotaları (login/tenant/org/main/portal/
/// settings/entity). PPM domain ekranları (contacts/my-work) çekirdek
/// [ScreenResolver]'a `ppm_screens.dart` ile kaydedilir; diğer CRM menü yolları
