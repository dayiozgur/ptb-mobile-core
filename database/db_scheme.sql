...
CREATE TABLE public.activities (
                                 ...
                                 CONSTRAINT activity_tenant_fkey FOREIGN KEY (tenant) REFERENCES public.tenants(id)
);
...
CREATE TABLE public.city (
                           ...
                           created_by uuid,
                           created_at timestamp with time zone,
                           row_id integer NOT NULL DEFAULT nextval('city_row_id_seq'::regclass),
                           updated_by uuid,
                           updated_at timestamp with time zone,
...
CREATE TABLE public.country (
                              ...
                              created_by uuid,
                              created_at timestamp with time zone,
                              row_id integer NOT NULL DEFAULT nextval('country_row_id_seq'::regclass),
                              updated_by uuid,
                              updated_at timestamp with time zone,
...
CREATE TABLE public.new_energy_consumption_summaries (
                                                       ...
                                                       data_quality_avg double precision,
                                                       anomaly_detected boolean DEFAULT false,
                                                       calculated_at timestamp with time zone DEFAULT now(),
                                                       CONSTRAINT new_energy_consumption_summaries_pkey PRIMARY KEY (controller_id, time, period_type),
                                                       CONSTRAINT new_energy_consumption_summary_controller_id_fkey FOREIGN KEY (controller_id) REFERENCES public.controllers(id)
);
CREATE TABLE public.new_energy_device_configs (
                                                id uuid NOT NULL DEFAULT gen_random_uuid(),
                                                controller_id uuid NOT NULL UNIQUE,
                                                device_name character varying NOT NULL,
                                                device_type character varying NOT NULL,
                                                is_active boolean DEFAULT true,
                                                primary_energy_variable_id uuid,
                                                secondary_energy_variables ARRAY,
                                                power_variables ARRAY,
                                                calculation_method character varying DEFAULT 'last_minus_first'::character varying,
                                                reset_detection boolean DEFAULT true,
                                                max_daily_consumption double precision,
                                                ...
                                                created_by uuid,
                                                updated_by uuid,
                                                CONSTRAINT new_energy_device_configs_pkey PRIMARY KEY (id),
                                                CONSTRAINT new_energy_device_config_controller_id_fkey FOREIGN KEY (controller_id) REFERENCES public.controllers(id),
                                                CONSTRAINT new_energy_device_config_primary_energy_variable_id_fkey FOREIGN KEY (primary_energy_variable_id) REFERENCES public.variables(id)
);
CREATE TABLE public.new_energy_readings (
                                          time timestamp with time zone NOT NULL,
                                          controller_id uuid NOT NULL,
                                          ...
                                          CONSTRAINT new_energy_readings_controller_id_fkey FOREIGN KEY (controller_id) REFERENCES public.controllers(id),
                                          CONSTRAINT new_energy_readings_variable_id_fkey FOREIGN KEY (variable_id) REFERENCES public.variables(id)
);
CREATE TABLE public.notifications (
  ...
  acknowledged_by uuid DEFAULT gen_random_uuid(),
  platform_id uuid DEFAULT gen_random_uuid(),
  profile_id uuid DEFAULT gen_random_uuid(),
  read boolean,
  CONSTRAINT notifications_pkey PRIMARY KEY (id),
  CONSTRAINT fkgj01f0fj191qsdmtojqdycgs5 FOREIGN KEY (acknowledged_by) REFERENCES public.profiles(id),
  CONSTRAINT fkbxdlekhbrqotqjkmhou8elvl0 FOREIGN KEY (platform_id) REFERENCES public.platforms(id),
  CONSTRAINT fk4dgeqtyhkodfpuikmw7e59ijh FOREIGN KEY (profile_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.pmp_attachments (
                                      id uuid NOT NULL DEFAULT gen_random_uuid(),
                                      entity_type text NOT NULL CHECK (entity_type = ANY (ARRAY['work_request'::text, 'task'::text, 'comment'::text])),
                                      entity_id uuid NOT NULL,
                                      ...
                                      active boolean DEFAULT true,
                                      created_at timestamp with time zone DEFAULT now(),
                                      CONSTRAINT pmp_attachments_pkey PRIMARY KEY (id),
                                      CONSTRAINT pmp_attachment_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.pmp_staffs(id)
);
CREATE TABLE public.pmp_comments (
                                   id uuid NOT NULL DEFAULT gen_random_uuid(),
                                   work_request_id uuid NOT NULL,
                                   ...
                                   CONSTRAINT pmp_comments_pkey PRIMARY KEY (id)
);
CREATE TABLE public.pmp_notification_preferences (
                                                   id uuid NOT NULL DEFAULT gen_random_uuid(),
                                                   staff_id uuid NOT NULL UNIQUE,
                                                   comment_added boolean DEFAULT true,
                                                   work_request_assigned boolean DEFAULT true,
                                                   work_request_status_changed boolean DEFAULT true,
                                                   task_assigned boolean DEFAULT true,
                                                   sprint_started boolean DEFAULT true,
                                                   sprint_completed boolean DEFAULT true,
                                                   ...
                                                   created_at timestamp with time zone DEFAULT now(),
                                                   updated_at timestamp with time zone DEFAULT now(),
                                                   CONSTRAINT pmp_notification_preferences_pkey PRIMARY KEY (id),
                                                   CONSTRAINT pmp_notification_preferences_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.pmp_staffs(id)
);
CREATE TABLE public.pmp_notifications (
                                        id uuid NOT NULL DEFAULT gen_random_uuid(),
                                        ...
                                        active boolean NOT NULL DEFAULT true,
                                        created_at timestamp with time zone NOT NULL DEFAULT now(),
                                        CONSTRAINT pmp_notifications_pkey PRIMARY KEY (id)
);
CREATE TABLE public.pmp_organizations (
                                        id uuid NOT NULL,
                                        name character varying,
                                        description character varying,
                                        address character varying,
                                        ...
                                        marker_id uuid,
                                        tenant_id uuid,
                                        row_id integer NOT NULL DEFAULT nextval('pmp_consumer_row_id_seq'::regclass),
                                        created_by uuid,
                                        updated_by uuid,
                                        CONSTRAINT pmp_organizations_pkey PRIMARY KEY (id),
                                        CONSTRAINT pmp_consumer_financial_fk FOREIGN KEY (financial_id) REFERENCES public.financials(id),
                                        CONSTRAINT pmp_consumer_marker_fk FOREIGN KEY (marker_id) REFERENCES public.markers(id),
                                        CONSTRAINT pmp_consumer_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.tenants(id)
);
CREATE TABLE public.pmp_projects (
                                   id uuid NOT NULL DEFAULT gen_random_uuid(),
                                   name character varying NOT NULL,
                                   description text,
                                   ...
                                   tenant_id uuid,
                                   CONSTRAINT pmp_projects_pkey PRIMARY KEY (id),
                                   CONSTRAINT pmp_project_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id),
                                   CONSTRAINT pmp_project_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.pmp_staffs(id),
                                   CONSTRAINT pmp_project_consumer_fkey FOREIGN KEY (consumer) REFERENCES public.pmp_organizations(id)
);
CREATE TABLE public.pmp_sprints (
                                  id uuid NOT NULL DEFAULT gen_random_uuid(),
                                  name character varying NOT NULL,
                                  description text,
                                  ...
                                  start_date date NOT NULL,
                                  end_date date NOT NULL,
                                  status character varying NOT NULL DEFAULT 'planned'::character varying CHECK (status::text = ANY (ARRAY['planned'::character varying, 'active'::character varying, 'completed'::character varying, 'cancelled'::character varying]::text[])),
                                  goal text,
                                  created_at timestamp with time zone DEFAULT now(),
                                  updated_at timestamp with time zone DEFAULT now(),
                                  created_by uuid,
                                  updated_by uuid,
                                  active boolean DEFAULT true,
                                  CONSTRAINT pmp_sprints_pkey PRIMARY KEY (id),
                                  CONSTRAINT pmp_sprint_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.pmp_projects(id)
);
CREATE TABLE public.pmp_staffs (
                                 id uuid NOT NULL DEFAULT gen_random_uuid(),
                                 first_name character varying NOT NULL,
                                 last_name character varying NOT NULL,
                                 email character varying NOT NULL UNIQUE,
                                 phone character varying,
                                 role character varying NOT NULL DEFAULT 'DEVELOPER'::character varying,
                                 active boolean DEFAULT true,
                                 consumer uuid,
                                 created_at timestamp with time zone DEFAULT now(),
                                 updated_at timestamp with time zone DEFAULT now(),
                                 CONSTRAINT pmp_staffs_pkey PRIMARY KEY (id)
);
CREATE TABLE public.pmp_tasks (
                                id uuid NOT NULL DEFAULT gen_random_uuid(),
                                title character varying NOT NULL,
                                description text,
                                ...
                                created_at timestamp with time zone DEFAULT now(),
                                updated_at timestamp with time zone DEFAULT now(),
                                CONSTRAINT pmp_tasks_pkey PRIMARY KEY (id),
                                CONSTRAINT pmp_task_assigned_to_fkey FOREIGN KEY (assigned_to) REFERENCES public.pmp_staffs(id),
                                CONSTRAINT pmp_task_work_request_id_fkey FOREIGN KEY (work_request_id) REFERENCES public.pmp_work_requests(id),
                                CONSTRAINT pmp_task_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.pmp_staffs(id)
);
CREATE TABLE public.pmp_teams (
                                id uuid NOT NULL DEFAULT gen_random_uuid(),
                                name character varying NOT NULL,
                                description text,
                                project_id uuid NOT NULL,
                                ...
                                created_at timestamp with time zone DEFAULT now(),
                                updated_at timestamp with time zone DEFAULT now(),
                                CONSTRAINT pmp_teams_pkey PRIMARY KEY (id),
                                CONSTRAINT pmp_team_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.pmp_projects(id)
);
CREATE TABLE public.pmp_work_requests (
                                        id uuid NOT NULL DEFAULT gen_random_uuid(),
                                        ...
                                        updated_at timestamp with time zone DEFAULT now(),
                                        sprint_id uuid,
                                        CONSTRAINT pmp_work_requests_pkey PRIMARY KEY (id),
                                        CONSTRAINT pmp_work_request_sprint_id_fkey FOREIGN KEY (sprint_id) REFERENCES public.pmp_sprints(id),
                                        CONSTRAINT pmp_work_request_assigned_to_fkey FOREIGN KEY (assigned_to) REFERENCES public.pmp_staffs(id),
                                        CONSTRAINT pmp_work_request_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.pmp_projects(id),
                                        CONSTRAINT pmp_work_request_consumer_fkey FOREIGN KEY (consumer) REFERENCES public.pmp_organizations(id),
                                        CONSTRAINT pmp_work_request_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.pmp_staffs(id)
);
...
CREATE TABLE public.productions (
  ...
  CONSTRAINT fk_production_tenant FOREIGN KEY (tenant) REFERENCES public.tenants(id)
);
...
CREATE TABLE public.projects (
                               ...
                               CONSTRAINT fkbrqhjdn2p35kl4yfgv1xq0vfm FOREIGN KEY (city_id) REFERENCES public.city(id),
                               ...
                               CONSTRAINT fkgxyxmg12hv49t1ljd14m4ym3m FOREIGN KEY (country_id) REFERENCES public.country(id),
...
CREATE TABLE public.realm_users (
                                  ...
                                  CONSTRAINT fkr9ego4hrcg2kchns83n5ht9ij FOREIGN KEY (tenant) REFERENCES public.tenants(id),
...
CREATE TABLE public.reservations (
  ...
  CONSTRAINT fk8e1rwcovg0rb67p1xsxyxpcqp FOREIGN KEY (city_id) REFERENCES public.city(id),
  ...
  CONSTRAINT fklluvu3k522yblaog7tisgbh0x FOREIGN KEY (country_id) REFERENCES public.country(id),
...
CREATE TABLE public.staffs (
                             ...
                             CONSTRAINT fkniewic6epjs2rvbjofqt8gbga FOREIGN KEY (city_id) REFERENCES public.city(id),
                             CONSTRAINT fkfue0dj3vxpojta3sud3fwgw8l FOREIGN KEY (country_id) REFERENCES public.country(id),
...
CREATE TABLE public.work_requests (
  ...
  CONSTRAINT fkkm8rctirmn6kuvvwptwnryr3d FOREIGN KEY (city_id) REFERENCES public.city(id),
  ...
  CONSTRAINT fkojl1depe3xhmdhgyjx9m87x6k FOREIGN KEY (country_id) REFERENCES public.country(id),
  ...
  CONSTRAINT work_request_sprint_id_fkey FOREIGN KEY (sprint_id) REFERENCES public.pmp_sprints(id)
);
...
CREATE TABLE public.workflow_histories (
                                         ...
                                         CONSTRAINT workflow_history_work_request_id_fkey FOREIGN KEY (work_request_id) REFERENCES public.pmp_work_requests(id),
                                         CONSTRAINT workflow_history_changed_by_fkey FOREIGN KEY (changed_by) REFERENCES public.pmp_staffs(id),
