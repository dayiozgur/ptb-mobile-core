...
import '../features/duplicates/crm_duplicates_screen.dart';
...
Widget? crmResolve(MenuItem item) {
  ...
  // Yinelenen kayıtlar: web menü-item'ı `/crm/duplicates` ZATEN var (nav.crm_duplicates).
  if (p == '/crm/duplicates') {
    return const CrmDuplicatesScreen();
  }
  return null;
}
