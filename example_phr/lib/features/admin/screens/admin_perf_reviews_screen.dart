...
class _AdminPerfReviewsScreenState extends State<AdminPerfReviewsScreen> {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      ...
      child: AsyncView<List<AdminPerformanceReview>>(
        controller: _ctrl,
        load: () => adminPerformanceService.allReviews(),
        errorFallback: essT('common.data_load_error', 'Veriler yüklenemedi'),
        isEmpty: (reviews) => reviews.isEmpty,
        emptyIcon: Icons.assignment_outlined,
        emptyTitle:
            essT('performance.reviews_admin.empty', 'Değerlendirme bulunamadı'),
        builder: (context, reviews) => _content(context, reviews),
      ),
    );
  }

  Widget _content(BuildContext context, List<AdminPerformanceReview> reviews) {
