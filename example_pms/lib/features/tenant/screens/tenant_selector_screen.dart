...
class _TenantSelectorScreenState extends State<TenantSelectorScreen> {
  ...
  Future<void> _loadTenants() async {
    ...
    try {
      ...
      if (userId == null) {
        setState(() {
          _error = 'Kullanici oturumu bulunamadi';
          _isLoading = false;
        });
        return;
      }
  ...
  Widget _buildContent() {
    ...
    if (_tenants.isEmpty) {
      return AppEmptyState(
        ...
        message: 'Henuz bir organizasyona dahil degilsiniz.',
        actionLabel: 'Yeni Organizasyon Olustur',
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          AppButton(
            label: 'Yeni Organizasyon Olustur',
              ...
              child: Column(
                ...
                children: [
                  AppTextField(
                    ...
                    placeholder: 'Orn: Sirketim A.S.',
                    prefixIcon: Icons.business,
                    validator: Validators.required('Organizasyon adi zorunludur'),
                      ...
                      if (context.mounted) {
                        ...
                        if (tenant != null) {
                          AppSnackbar.showSuccess(
                            context,
                            message: 'Organizasyon olusturuldu',
                          );
                          _loadTenants();
                        } else {
                          AppSnackbar.showError(
                            context,
                            message: 'Organizasyon olusturulamadi',
                          );
                        }
                      }
                    },
