...
class _OrganizationSelectorScreenState
  ...
  Future<void> _loadOrganizations() async {
    ...
    try {
      ...
      if (tenantId == null) {
        setState(() {
          _error = sl<LocalizationService>().translate('org.tenant_not_selected');
          _isLoading = false;
        });
        return;
      }
      ...
      setState(() {
        _error = sl<LocalizationService>().translate('org.load_failed');
        _isLoading = false;
      });
    }
  }
  ...
  Future<void> _selectOrganization(Organization organization) async {
    ...
    if (success && mounted) {
      ...
      AppSnackbar.showError(
        context,
        message: sl<LocalizationService>().translate('org.select_failed'),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      title: sl<LocalizationService>().translate('org.select_title'),
      showBackButton: true,
  ...
  Widget _buildContent() {
    ...
    if (_organizations.isEmpty) {
      return AppEmptyState(
        ...
        title: sl<LocalizationService>().translate('org.not_found'),
        message: sl<LocalizationService>().translate('org.none_in_tenant'),
      );
    }
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          Text(
            sl<LocalizationService>().translate('org.select_prompt'),
